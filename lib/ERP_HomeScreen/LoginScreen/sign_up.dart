...
class _SignupScreenState extends State<SignupScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    const Color brandColor = Color(0xff26A69A); // Green theme
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    _socialButton('assets/google.png'), // These icons might need path checks later
  ...
  Widget _socialButton(String assetPath) {
    return InkWell(
      ...
      child: Image.asset(assetPath, width: 44, height: 44, errorBuilder: (c, e, s) => const Icon(Icons.error_outline),),
    );
  }
  ...
  Future<void> _signupApiCall() async {
    ...
    try {
      ...
      // ... API call to erpsmart.in ...
      */

      await Future.delayed(const Duration(milliseconds: 1500));

      _showSnack("Signup successful (Demo)", true);
      ...
      if (mounted) _showSnack("Server error", false);
    }
