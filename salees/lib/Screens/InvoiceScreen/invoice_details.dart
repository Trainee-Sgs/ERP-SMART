                ...
                children: [
                  ...
                  Row(
                    children: [
                      Text(
                        'Bill to: ',
                        style: TextStyle(fontSize: 16.sp, fontWeight: FontWeight.bold, color: const Color(0xFF2E3B9E)),
                      ),
                      Text(
                        'Sowmiya',
  ...
  Widget _buildCell(String text, {int flex = 1, bool isHeader = false}) {
    return Expanded(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          border: Border(
            right: flex == 1 || text == 'Discount' ? BorderSide.none : BorderSide(color: const Color(0xFF2E3B9E).withOpacity(0.5)),
            left: text == 'Product' ? BorderSide.none : BorderSide(color: const Color(0xFF2E3B9E).withOpacity(0.5)),
          ),
        ),
        child: Text(
          text,
          ...
          style: TextStyle(
            ...
            color: isHeader ? const Color(0xFF2E3B9E) : Colors.black87,
          ),
        ),
      ),
    );
  ...
  Widget _buildSummaryRow(String label, String value) {
    return Row(
      ...
      children: [
        Text(
          label,
          style: TextStyle(fontSize: 14.sp, color: const Color(0xFF2E3B9E)),
        ),
        Text(
          value,
