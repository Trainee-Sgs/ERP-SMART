...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  final TextEditingController _txnController = TextEditingController(text: 'TXN20260302001');
  final TextEditingController _dateController = TextEditingController(text: '12-03-2026');
  ...
  Widget _buildTextField({
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        suffixIcon: suffixIcon != null ? Icon(suffixIcon, color: Colors.grey, size: 20.sp) : null,
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(8.r),
          borderSide: const BorderSide(color: Color(0xFF2E3B9E), width: 1.5),
        ),
      ),
  ...
  Widget _buildDropdown({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(8.r),
        border: Border.all(color: const Color(0xFF2E3B9E)),
      ),
