                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(color: const Color(0xFF2E3B9E), width: 2.w),
                    ),
                    child: Padding(
                      padding: EdgeInsets.all(8.r),
                      child: CircleAvatar(
                        backgroundColor: Colors.white,
                        child: Icon(Icons.person_outline, size: 70.sp, color: const Color(0xFF2E3B9E)),
                      ),
                    ),
                  ),
                  Container(
                    ...
                    child: Icon(Icons.edit_outlined, size: 20.sp, color: const Color(0xFF2E3B9E)),
                  ),
                ],
              ),
            ),
