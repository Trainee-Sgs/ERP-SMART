...
class _AccountSettingScreenState extends State<AccountSettingScreen> {
    ...
    if (mounted) {
      setState(() {
        if (profileData != null) {
          ...
          _phoneController.text = profileData['mobile'] ?? 'N/A';
        } else {
          _nameController.text = prefs.getString('name') ?? 'N/A';
          _emailController.text = prefs.getString('email') ?? 'N/A';
          _phoneController.text = prefs.getString('number') ?? 'N/A';
        }

        _userNameController.text = prefs.getString('uname') ?? 'N/A';
        ...
        if (lt.isNotEmpty && ln.isNotEmpty) {
          ...
          _locationController.text = prefs.getString('com_address') ?? 'N/A';
        }
        _isLoading = false;
      });
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _isLoading
          ? const Center(
              child: CircularProgressIndicator(color: Color(0xFF6B4195)),
            )
