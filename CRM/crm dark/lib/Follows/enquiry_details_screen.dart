...
class _EnquiryDetailsScreenState extends State<EnquiryDetailsScreen> {
  ...
  Future<void> _fetchTimelineData() async {
    ...
    final String leadNo = widget.lead?['enquiry_date']?.toString() ?? '';
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        _buildDetailField(
                          'Project Value',
                          widget.lead?['project_value']?.toString() ??
                              '₹20,00,00',
                        ),
                        _buildDetailField(
                          'Name',
                          widget.lead?['cus_name']?.toString() ?? 'Ganesh',
                        ),
                        _buildDetailField(
                          'Lead No',
                          widget.lead?['enquiry_date']?.toString() ?? 'L001',
                        ),
                        _buildDetailField(
                          'Phone No',
                          widget.lead?['mobile_num']?.toString() ??
                              '7894561231',
                        ),
                        _buildDetailField(
                          'WhatsApp No',
                          widget.lead?['wp_num']?.toString() ?? '7894561231',
                        ),
                        _buildDetailField(
                          'Email ID',
                          widget.lead?['email']?.toString() ??
                              'Ganesh@gmail.com',
                        ),
                        _buildDetailField(
                          'Date Created',
                          widget.lead?['created_date']?.toString() ??
