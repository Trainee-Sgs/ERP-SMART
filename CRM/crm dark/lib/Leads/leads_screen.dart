...
class _LeadsScreenState extends State<LeadsScreen> {
  ...
  final List<dynamic> _mockLeads = [
    {
      'cus_name': 'Sathya Narayanan',
      'enquiry_date': '2024-02-23',
      'mobile_num': '9123456780',
      'email': 'sathya@example.com',
      'comany_name': 'Tech Solutions',
    },
    {
      'cus_name': 'Arun Kumar',
      'enquiry_date': '2024-02-22',
      'mobile_num': '9876543210',
      'email': 'arun@example.com',
      'comany_name': 'Creative Minds',
    },
    {
      'cus_name': 'Priya Dharshini',
      'enquiry_date': '2024-02-21',
      'mobile_num': '9000800070',
      'email': 'priya@example.com',
      'comany_name': 'Innovate Hub',
    },
  ];
  ...
  Future<void> _fetchLeads() async {
    ...
    if (mounted) {
      setState(() {
        _allLeads = _mockLeads;
        _isLoading = false;
      });
    }

    debugPrint("Loaded ${_allLeads.length} mock leads.");
  }
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Column(
                        ...
                        children: [
                          ...
                          _buildLeadCard(
                            lead: lead,
                            name: lead['cus_name']?.toString() ?? 'N/A',
                            leadNo: 'No: ${lead['enquiry_date'] ?? 'N/A'}',
                            phone: lead['mobile_num']?.toString() ?? 'N/A',
                            email: lead['email']?.toString() ?? 'N/A',
                            reference:
                                lead['comany_name']?.toString() ?? 'Reference',
